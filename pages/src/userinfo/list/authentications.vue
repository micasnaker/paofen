<template>
	<view class="avatar_change" style="padding: 40upx">
		...
		<view v-if="message.is_auth==0"><button @tap="Submission" class="landing" type="primary">提交</button></view>
		<view v-if="message.is_auth==1"><button class="landing" type="primary">实名认证审核中</button></view>
		<view v-if="message.is_auth==2"><button class="landing" type="primary">实名认证已通过</button></view>
		<view v-if="message.is_auth==-1"><button @tap="Submission" class="landing" type="primary">提交</button></view>
	</view>
</template>
